...
public class Architect {
    public static void main(String[] args) {
        ...
        PermitPlan secondPermitPlan = new ConstructionPlan(100, "Iroda", "Szabó Emese", "Szolnok", 42);
        ...
        ConstructionPlan constructionPlan = new ConstructionPlan(100, "Iroda", "Szabó Emese", "Szolnok", 42);
        ...
        System.out.println(constructionPlan.getSheetOfConstructionDrawings());
    }
}
