...
public class Danube extends River {
    ...
    public static void main(String[] args) {
        ...
        Water water = new Danube("Duna", 2850, Arrays.asList("Budapest", "Belgrád", "Bécs"));
        System.out.println();

        River river = new Danube("Duna", 2850, Arrays.asList("Budapest", "Belgrád", "Bécs"));
        System.out.println(river.getName());
        System.out.println(river.getLength());

        Danube danube = new Danube("Duna", 2850, Arrays.asList("Budapest", "Belgrád", "Bécs"));
